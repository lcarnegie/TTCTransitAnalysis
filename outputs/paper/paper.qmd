---
title: "Transit Delays in the Toronto Transit Commission"
...
```
Subways didn't have any reason for delay, yet have the most incidence of delay. Was dropped from the data.  
...
```{r ggplot incidence change monthly}
#| message: false
#| echo: false
#| warning: false
#| label: monthly-delay-incidence
